...
function! s:full_to_base(full, is_posix) abort
...
function! ddc_file#internal#info(is_posix) abort
  ...
  let input_file_base = s:full_to_base(input_file_full, a:is_posix)
...
function! ddc_file#internal#_test() abort
  ...
  try
    ...
    call assert_equal('./a', s:line_to_file_full('\./a', v:true))
    call assert_equal('', s:full_to_base('', v:true))
    call assert_equal('', s:full_to_base('a', v:true))
    call assert_equal('', s:full_to_base('abc', v:true))
    call assert_equal('', s:full_to_base('/abc', v:true))
    call assert_equal('.', s:full_to_base('.', v:true))
    call assert_equal('.', s:full_to_base('.a', v:true))
    call assert_equal('.', s:full_to_base('.abc', v:true))
    ...
    call assert_equal('.', s:full_to_base('./.', v:true))
    call assert_equal('.', s:full_to_base('./.a', v:true))
    call assert_equal('.a.', s:full_to_base('./.a.', v:true))
    call assert_equal('.a.', s:full_to_base('./.a.b', v:true))
    call assert_equal('.a.b.', s:full_to_base('./.a.b.', v:true))
    call assert_equal('', s:full_to_base('./a', v:true))
    call assert_equal('a.', s:full_to_base('./a.', v:true))
    call assert_equal('a.', s:full_to_base('./a.b', v:true))
    call assert_equal('a.b.', s:full_to_base('./a.b.', v:true))
    ...
    call assert_equal('/.\a', s:line_to_file_full('/.\a', v:false))
    call assert_equal('', s:full_to_base('', v:false))
    call assert_equal('', s:full_to_base('a', v:false))
    call assert_equal('', s:full_to_base('abc', v:false))
    call assert_equal('', s:full_to_base('\abc', v:false))
    call assert_equal('.', s:full_to_base('.', v:false))
    call assert_equal('.', s:full_to_base('.a', v:false))
    call assert_equal('.', s:full_to_base('.abc', v:false))
    ...
    call assert_equal('.', s:full_to_base('.\.', v:false))
    call assert_equal('.', s:full_to_base('.\.a', v:false))
    call assert_equal('.a.', s:full_to_base('.\.a.', v:false))
    call assert_equal('.a.', s:full_to_base('.\.a.b', v:false))
    call assert_equal('.a.b.', s:full_to_base('.\.a.b.', v:false))
    call assert_equal('', s:full_to_base('.\a', v:false))
    call assert_equal('a.', s:full_to_base('.\a.', v:false))
    call assert_equal('a.', s:full_to_base('.\a.b', v:false))
    call assert_equal('a.b.', s:full_to_base('.\a.b.', v:false))
